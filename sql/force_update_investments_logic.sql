-- Force update the investment logic to ensure 0.5% per token sensitivity
-- This overwrites any previous version of invest_in_user

-- Add available_shares column if not exists (idempotent)
alter table public.profiles
add column if not exists available_shares numeric default 1000000;

-- Update the investment function
